...
<header class="main-header header-style-one">
    <div class="header-style-one__inner">
        <div class="main-logo-box">
            <a href="{{ url('/') }}"><img src="assets/images/resources/logo.png" alt="Awesome Logo" title=""></a>
        </div>
        <!--Start Header Top-->
                            ...
                            <div class="header-contact-info text-right-rtl">
                                <ul>
                                    <li>
                                        ...
                                        <div class="text">
                                            <h6><a href="tel:+998999957665">+998 995 76 65</a></h6>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon">
                                        ...
                                        <div class="text">
                                            <h6><a href="https://turgunoff-group.uz/">turgunoffuz@gmail.com</a></h6>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="outer-box">
                        ...
                        <div class="header-right">
                            <div class="shopping-cart-box">
                                <a href="#"><i class="flaticon-shopping-bag"></i><span
                            ...
                            <div class="header-right_buttom">
                                <div class="btns-box">
                                    <a class="btn-one" href="{{ url('/contact') }}">
        ...
        <div class="container">
            <div class="clearfix">
                ...
                <div class="logo float-left">
                    <a href="{{ url('/') }}" class="img-responsive"><img
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="{{ url('/') }}"><img src="assets/images/resources/mobilemenu-logo.png"
                                                                alt="" title=""></a></div>
